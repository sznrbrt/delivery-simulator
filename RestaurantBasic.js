...
function RestaurantBasic(x, y, pickupX, pickupY, vehicleInitialX, vehicleInitialY, color, numOfVehicle) {
  this.color = color;
...
RestaurantBasic.prototype.update = function (delta) {
...
RestaurantBasic.prototype.draw = function () {
...
RestaurantBasic.prototype.addOrder = function (data) {
  // console.log(data);
