...
// Constructor for the Vector2 class, which makes working with 2D coordinates easier with the help of vector operations(addition, subtraction, comparison etc.)
